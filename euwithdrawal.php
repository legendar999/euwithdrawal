...
class Euwithdrawal extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->ps_versions_compliancy = ['min' => '1.6.0.0', 'max' => '1.6.99.99'];
    }
    ...
    {
        $p = ['fc' => 'module', 'module' => 'euwithdrawal', 'controller' => 'withdrawal'];
        $routes = [
            // Primary route (default-language slug) so Link::getModuleLink() still resolves.
            'module-euwithdrawal-withdrawal' => [
        ...
        foreach (Language::getLanguages(false) as $lang) {
            $routes['module-euwithdrawal-withdrawal-' . (int) $lang['id_lang']] = [
                'controller' => 'withdrawal',
    ...
    public function getWithdrawalLink($id_lang = null)
    {
        ...
        return $this->context->link->getModuleLink('euwithdrawal', 'withdrawal', [], null, $id_lang);
    }
    ...
    {
        $d = [
            'sl' => ['label' => 'Odstop od pogodbe', 'slug' => 'odstop-od-pogodbe',
            ...
            'en' => ['label' => 'Withdrawal from contract', 'slug' => 'withdrawal-from-contract',
            ...
            'hr' => ['label' => 'Odustanak od ugovora', 'slug' => 'odustanak-od-ugovora',
            ...
            'cs' => ['label' => 'Odstoupení od smlouvy', 'slug' => 'odstoupeni-od-smlouvy',
            ...
            'hu' => ['label' => 'Elállás a szerződéstől', 'slug' => 'elallas-a-szerzodestol',
            ...
            'it' => ['label' => 'Recesso dal contratto', 'slug' => 'recesso-dal-contratto',
            ...
            'sk' => ['label' => 'Odstúpenie od zmluvy', 'slug' => 'odstupenie-od-zmluvy',
            ...
            'de' => ['label' => 'Widerruf des Vertrags', 'slug' => 'widerruf-des-vertrags',
            ...
            'fr' => ['label' => 'Rétractation du contrat', 'slug' => 'retractation-du-contrat',
            ...
            'es' => ['label' => 'Desistimiento del contrato', 'slug' => 'desistimiento-del-contrato',
